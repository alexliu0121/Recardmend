...
class cosmed_discount extends StatefulWidget {
  @override
...
class discount extends State<cosmed_discount> {
  int _currentIndex = 0;
...
class HomePage extends StatelessWidget {
  Future getData_taishin() async {
    ...
    QuerySnapshot qn =
        await firestore.collection('台新銀行').where('店家', isEqualTo: '康是美').get();
  ...
  Future getData_yushan() async {
    var firestore = FirebaseFirestore.instance;
    QuerySnapshot qn =
        await firestore.collection('玉山銀行').where('店家', isEqualTo: '康是美').get();
                      ...
                      children: [
                        Container(
                          ...
                          child: Column(
                            children: [
                              Image(
                                image: AssetImage('assets/康是美.png'),
                                width: 100,
                                height: 100,
                              )
                            ],
